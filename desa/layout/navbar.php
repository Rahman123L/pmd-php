        ...
        <div class="flex items-center gap-5 md:gap-6">
            ...
            <div x-data="{ isOpen : false }" class="relative space-y-3">
                    ...
                    <div x-show="isOpen" @click.outside="isOpen = false" x-transition.duration.300ms.opacity.50 :class="{ 'block': isOpen, 'hidden': !isOpen }" class="hidden w-max absolute right-0">
                        <div x-data="{ tab : 1 }" class="grid w-60 sm:w-72 md:w-80 lg:w-96 bg-white rounded md:rounded-md shadow-lg shadow-black/20">
                            ...
                            <div x-show="tab == 1" class="space-y-3">
                                <div class="grid">
                                    <a href="" class="flex items-center bg-[#92FF7524] py-3 px-4 gap-3 md:gap-4">
                                        <svg class="w-5 ring-[6px] ring-[#D9FFCC] rounded-full" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.0039 0.148438C8.0261 0.148438 6.0927 0.734927 4.44821 1.83374C2.80372 2.93255 1.52199 4.49434 0.765115 6.3216C0.00823909 8.14886 -0.189794 10.1595 0.196058 12.0993C0.58191 14.0391 1.53432 15.821 2.93284 17.2195C4.33137 18.618 6.1132 19.5704 8.05301 19.9563C9.99282 20.3421 12.0035 20.1441 13.8307 19.3872C15.658 18.6304 17.2198 17.3486 18.3186 15.7041C19.4174 14.0596 20.0039 12.1262 20.0039 10.1484C19.9988 7.49783 18.9436 4.95725 17.0694 3.08298C15.1951 1.20872 12.6545 0.15352 10.0039 0.148438ZM14.7635 8.39844L9.12891 13.7831C8.98324 13.9201 8.79044 13.9958 8.59045 13.9946C8.4927 13.996 8.39564 13.978 8.30487 13.9417C8.2141 13.9054 8.13142 13.8515 8.0616 13.7831L5.24429 11.0907C5.16615 11.0226 5.1026 10.9393 5.05746 10.8459C5.01232 10.7526 4.98653 10.651 4.98163 10.5475C4.97673 10.4439 4.99282 10.3404 5.02894 10.2432C5.06507 10.146 5.12047 10.0571 5.19183 9.98181C5.26318 9.90656 5.34902 9.84651 5.44417 9.80529C5.53933 9.76406 5.64183 9.74249 5.74553 9.74189C5.84923 9.74129 5.95198 9.76166 6.04761 9.80178C6.14323 9.8419 6.22976 9.90094 6.30199 9.97536L8.59045 12.158L13.7058 7.28305C13.8554 7.15256 14.0496 7.08494 14.2479 7.09432C14.4462 7.1037 14.6331 7.18936 14.7697 7.33339C14.9063 7.47742 14.9819 7.66867 14.9808 7.86715C14.9796 8.06564 14.9018 8.256 14.7635 8.39844Z" fill="#289900"/>
                                        </svg>
                                        <div class="text-start space-y-1">
                                            <div class="">
                                                <h1 class="text-xs md:text-sm text-black font-semibold">Laporan sudah dilihat</h1>
                                                <p class="text-[10px] md:text-xs text-black font-normal">file laporan anda sudah dikonfirmasi oleh admin PMD</p>
                                            </div>
                                            <h1 class="text-[8px] md:text-[10px] text-[#B4B4B4] font-normal">Baru saja</h1>
                                        </div>
                                    </a>
                                    <a href="" class="flex items-center bg-[#FF808024] py-3 px-4 gap-3 md:gap-4">
                                        <svg class="w-5 ring-[6px] ring-[#FDCECE] rounded-full" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.0039 0.648438C8.0261 0.648438 6.0927 1.23493 4.44821 2.33374C2.80372 3.43255 1.52199 4.99434 0.765115 6.8216C0.00823909 8.64886 -0.189794 10.6595 0.196058 12.5993C0.58191 14.5391 1.53432 16.321 2.93284 17.7195C4.33137 19.118 6.1132 20.0704 8.05301 20.4563C9.99282 20.8421 12.0035 20.6441 13.8307 19.8872C15.658 19.1304 17.2198 17.8486 18.3186 16.2041C19.4174 14.5596 20.0039 12.6262 20.0039 10.6484C19.9988 7.99783 18.9436 5.45725 17.0694 3.58298C15.1951 1.70872 12.6545 0.65352 10.0039 0.648438ZM13.6289 13.1773C13.7734 13.3231 13.8544 13.5201 13.8544 13.7254C13.8544 13.9306 13.7734 14.1276 13.6289 14.2734C13.4819 14.4156 13.2854 14.4951 13.0808 14.4951C12.8763 14.4951 12.6798 14.4156 12.5328 14.2734L10.0039 11.735L7.47506 14.2734C7.32803 14.4156 7.13151 14.4951 6.92699 14.4951C6.72246 14.4951 6.52594 14.4156 6.37891 14.2734C6.23446 14.1276 6.15343 13.9306 6.15343 13.7254C6.15343 13.5201 6.23446 13.3231 6.37891 13.1773L8.91737 10.6484L6.37891 8.11959C6.25625 7.97013 6.19356 7.78039 6.20304 7.58727C6.21253 7.39416 6.29351 7.21147 6.43023 7.07475C6.56694 6.93803 6.74963 6.85706 6.94275 6.84757C7.13586 6.83809 7.3256 6.90077 7.47506 7.02344L10.0039 9.5619L12.5328 7.02344C12.6822 6.90077 12.872 6.83809 13.0651 6.84757C13.2582 6.85706 13.4409 6.93803 13.5776 7.07475C13.7143 7.21147 13.7953 7.39416 13.8048 7.58727C13.8143 7.78039 13.7516 7.97013 13.6289 8.11959L11.0904 10.6484L13.6289 13.1773Z" fill="#F30C0C"/>
                                        </svg>
                                        <div class="text-start space-y-1">
                                            <div class="">
                                                <h1 class="text-xs md:text-sm text-black font-semibold">Laporan sudah dilihat</h1>
                                                <p class="text-[10px] md:text-xs text-black font-normal">file laporan anda harus direvisi</p>
                                            </div>
                                            <h1 class="text-[8px] md:text-[10px] text-[#B4B4B4] font-normal">Baru saja</h1>
                                        </div>
                                    </a>
                                    <a href="" class="flex items-center bg-[#FFC97A24] py-3 px-4 gap-3 md:gap-4">
                                        <svg class="w-5 ring-[6px] ring-[#FEEED7] rounded-full" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.0039 0.148438C8.0261 0.148438 6.0927 0.734927 4.44821 1.83374C2.80372 2.93255 1.52199 4.49434 0.765115 6.3216C0.00823909 8.14886 -0.189794 10.1595 0.196058 12.0993C0.58191 14.0391 1.53432 15.821 2.93284 17.2195C4.33137 18.618 6.1132 19.5704 8.05301 19.9563C9.99282 20.3421 12.0035 20.1441 13.8307 19.3872C15.658 18.6304 17.2198 17.3486 18.3186 15.7041C19.4174 14.0596 20.0039 12.1262 20.0039 10.1484C19.9988 7.49783 18.9436 4.95725 17.0694 3.08298C15.1951 1.20872 12.6545 0.15352 10.0039 0.148438ZM9.23468 5.53305C9.23468 5.32904 9.31572 5.13338 9.45998 4.98912C9.60424 4.84486 9.7999 4.76382 10.0039 4.76382C10.2079 4.76382 10.4036 4.84486 10.5478 4.98912C10.6921 5.13338 10.7731 5.32904 10.7731 5.53305V10.9177C10.7731 11.1217 10.6921 11.3173 10.5478 11.4616C10.4036 11.6059 10.2079 11.6869 10.0039 11.6869C9.7999 11.6869 9.60424 11.6059 9.45998 11.4616C9.31572 11.3173 9.23468 11.1217 9.23468 10.9177V5.53305ZM10.0039 15.533C9.7757 15.533 9.55262 15.4654 9.36287 15.3386C9.17312 15.2118 9.02523 15.0316 8.93789 14.8208C8.85056 14.6099 8.82771 14.3779 8.87223 14.1541C8.91675 13.9303 9.02665 13.7247 9.18802 13.5633C9.34938 13.4019 9.55498 13.2921 9.7788 13.2475C10.0026 13.203 10.2346 13.2259 10.4455 13.3132C10.6563 13.4005 10.8365 13.5484 10.9633 13.7382C11.0901 13.9279 11.1578 14.151 11.1578 14.3792C11.1578 14.6852 11.0362 14.9787 10.8198 15.1951C10.6034 15.4115 10.3099 15.533 10.0039 15.533Z" fill="#C27605"/>
                                        </svg>
                                        <div class="text-start space-y-1">
                                            <div class="">
                                                <h1 class="text-xs md:text-sm text-black font-semibold">Laporan sudah dilihat</h1>
                                                <p class="text-[10px] md:text-xs text-black font-normal">file laporan anda sedang dalam proses pengecekan admin PMD</p>
                                            </div>
                                            <h1 class="text-[8px] md:text-[10px] text-[#B4B4B4] font-normal">Baru saja</h1>
                                        </div>
                                    </a>
                                    <a href="" class="flex items-center bg-[#7BD8FF24] py-3 px-4 gap-3 md:gap-4">
                                        <svg class="w-5 ring-[6px] ring-[#CCF0FF] rounded-full" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.0039 0.648438C8.0261 0.648438 6.0927 1.23493 4.44821 2.33374C2.80372 3.43255 1.52199 4.99434 0.765115 6.8216C0.00823909 8.64886 -0.189794 10.6595 0.196058 12.5993C0.58191 14.5391 1.53432 16.321 2.93284 17.7195C4.33137 19.118 6.1132 20.0704 8.05301 20.4563C9.99282 20.8421 12.0035 20.6441 13.8307 19.8872C15.658 19.1304 17.2198 17.8486 18.3186 16.2041C19.4174 14.5596 20.0039 12.6262 20.0039 10.6484C19.9988 7.99783 18.9436 5.45725 17.0694 3.58298C15.1951 1.70872 12.6545 0.65352 10.0039 0.648438ZM9.8116 5.26382C10.0398 5.26382 10.2629 5.33149 10.4526 5.45828C10.6424 5.58507 10.7903 5.76527 10.8776 5.97611C10.9649 6.18695 10.9878 6.41895 10.9433 6.64277C10.8988 6.8666 10.7889 7.07219 10.6275 7.23356C10.4661 7.39493 10.2605 7.50482 10.0367 7.54934C9.81288 7.59386 9.58088 7.57101 9.37004 7.48368C9.15921 7.39635 8.979 7.24846 8.85221 7.05871C8.72543 6.86896 8.65775 6.64588 8.65775 6.41767C8.65775 6.11165 8.77932 5.81816 8.99571 5.60177C9.2121 5.38539 9.50558 5.26382 9.8116 5.26382ZM10.7731 16.033H10.0039C9.7999 16.033 9.60424 15.952 9.45998 15.8077C9.31572 15.6635 9.23468 15.4678 9.23468 15.2638V10.6484C9.03067 10.6484 8.83501 10.5674 8.69075 10.4231C8.54649 10.2789 8.46545 10.0832 8.46545 9.8792C8.46545 9.67519 8.54649 9.47954 8.69075 9.33528C8.83501 9.19102 9.03067 9.10997 9.23468 9.10997H10.0039C10.2079 9.10997 10.4036 9.19102 10.5478 9.33528C10.6921 9.47954 10.7731 9.67519 10.7731 9.8792V14.4946C10.9772 14.4946 11.1728 14.5756 11.3171 14.7199C11.4613 14.8641 11.5424 15.0598 11.5424 15.2638C11.5424 15.4678 11.4613 15.6635 11.3171 15.8077C11.1728 15.952 10.9772 16.033 10.7731 16.033Z" fill="#01648E"/>
                                        </svg>
                                        <div class="text-start space-y-1">
                                            <div class="">
                                                <h1 class="text-xs md:text-sm text-black font-semibold">Laporan sudah dilihat</h1>
                                                <p class="text-[10px] md:text-xs text-black font-normal">file laporan anda sedang dalam antrian</p>
                                            </div>
                                            <h1 class="text-[8px] md:text-[10px] text-[#B4B4B4] font-normal">Baru saja</h1>
                                        </div>
                                    </a>
                            ...
                            <div x-show="tab == 3">
                                <!-- <div class="grid">
                                    <a href="" class="flex items-center bg-transparent py-3 px-4 gap-3 md:gap-4">
                                        <svg class="w-5 ring-[6px] ring-[#D9FFCC] rounded-full" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.0039 0.148438C8.0261 0.148438 6.0927 0.734927 4.44821 1.83374C2.80372 2.93255 1.52199 4.49434 0.765115 6.3216C0.00823909 8.14886 -0.189794 10.1595 0.196058 12.0993C0.58191 14.0391 1.53432 15.821 2.93284 17.2195C4.33137 18.618 6.1132 19.5704 8.05301 19.9563C9.99282 20.3421 12.0035 20.1441 13.8307 19.3872C15.658 18.6304 17.2198 17.3486 18.3186 15.7041C19.4174 14.0596 20.0039 12.1262 20.0039 10.1484C19.9988 7.49783 18.9436 4.95725 17.0694 3.08298C15.1951 1.20872 12.6545 0.15352 10.0039 0.148438ZM14.7635 8.39844L9.12891 13.7831C8.98324 13.9201 8.79044 13.9958 8.59045 13.9946C8.4927 13.996 8.39564 13.978 8.30487 13.9417C8.2141 13.9054 8.13142 13.8515 8.0616 13.7831L5.24429 11.0907C5.16615 11.0226 5.1026 10.9393 5.05746 10.8459C5.01232 10.7526 4.98653 10.651 4.98163 10.5475C4.97673 10.4439 4.99282 10.3404 5.02894 10.2432C5.06507 10.146 5.12047 10.0571 5.19183 9.98181C5.26318 9.90656 5.34902 9.84651 5.44417 9.80529C5.53933 9.76406 5.64183 9.74249 5.74553 9.74189C5.84923 9.74129 5.95198 9.76166 6.04761 9.80178C6.14323 9.8419 6.22976 9.90094 6.30199 9.97536L8.59045 12.158L13.7058 7.28305C13.8554 7.15256 14.0496 7.08494 14.2479 7.09432C14.4462 7.1037 14.6331 7.18936 14.7697 7.33339C14.9063 7.47742 14.9819 7.66867 14.9808 7.86715C14.9796 8.06564 14.9018 8.256 14.7635 8.39844Z" fill="#289900"/>
                                        </svg>
                                        <div class="text-start space-y-1">
                ...
                <div x-data="{ isOpen : false }" class="relative space-y-3">
                    ...
                    <div x-data="{ pesan : 1 }" x-show="isOpen" @click.outside="isOpen = false" x-transition.duration.300ms.opacity.50 :class="{ 'block': isOpen, 'hidden': !isOpen }" class="hidden w-max absolute right-0">
                        <div x-show="pesan == 1" class="grid w-60 sm:w-72 md:w-80 lg:w-96 bg-white rounded md:rounded-md shadow-lg shadow-black/20">
                            <div class="p-4 border-b border-[#eaeaea]">
                                <h1 class="text-start text-xs md:text-sm text-black font-normal">Inbox</h1>
                            </div>
                            ...
                            <div class="grid">
                                <a href="" class="bg-white py-3 px-4">
                                    <div class="md:flex md:justify-between items-center">
                                        ...
                                        <h1 class="ml-9 md:ml-0 text-[8px] md:text-[10px] text-[#B4B4B4] font-normal">Baru saja</h1>
                                    </div>
                                </a>
                                <a href="" class="bg-white py-3 px-4">
                                    <div class="md:flex md:justify-between items-center">
                        ...
                        <div x-show="pesan == 2">
                            <form action="" method="" x-show="isOpen" x-transition.duration.300ms.opacity.50 @click.outside="isOpen = false" class="flex flex-col justify-between items-center w-72 h-80 bg-white rounded-xl shadow-md shadow-[#0000001A]">
                                ...
                                <div class="w-full p-3.5 space-y-2.5">
                                    <div class="space-y-2">
                                        <div class="bg-white py-1.5 px-3 rounded md:rounded-md shadow-md shadow-[#0000001A]">
                                            <h1 class="text-end text-[10px] md:text-xs text-black font-normal">Halo Admin Tolong acc akun saya</h1>
                                        </div>
                                        <div class="bg-white py-1.5 px-3 rounded md:rounded-md shadow-md shadow-[#0000001A]">
                                            <h1 class="text-end text-[10px] md:text-xs text-black font-normal">Halo Admin Tolong acc akun saya</h1>
                                        </div>
            ...
            <div x-data="{ isOpen : false }" class="relative space-y-3">
                <button @click="isOpen = !isOpen" class="flex items-center gap-2 md:gap-3 md:border-l md:border-gray-300 md:pl-5">
                    <img class="w-7 lg:w-8 h-7 lg:h-8 bg-transparent object-cover rounded-full" src="/images/avatar.jpg">
                    <div class="hidden md:block text-xs md:text-sm text-black font-semibold capitalize">Admin DESA</div>

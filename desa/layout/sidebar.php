<aside x-show="isOpen" 
    ...
    class="hidden fixed top-0 left-0 z-50 w-60 bg-gradient-to-b from-[#615EFC] to-[#4C3896] to-[100%] shadow-xl h-screen scrollbar-y"
    ...
    <div class="grid gap-3 mt-5">
        <a href="dashboard.php">
            <button class="w-full relative group flex items-center gap-2 md:gap-3 pr-5">
                ...
                <div :class="isOpenn ? 'py-1.5' : 'justify-center py-2'" class="flex items-center gap-2 md:gap-3 w-full py-1.5 px-3 bg-transparent transition-colors duration-300 group-hover:bg-white group-focus:bg-white rounded-md group-hover:shadow-lg group-hover:shadow-black/20 group-focus:shadow-lg group-focus:shadow-black/20">
                    <svg class="w-[14px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold transition-colors duration-300 group-hover:text-[#615EFC] group-focus:text-[#615EFC]">Dashboard</h1>
                </div>
            </button>
        </a>
        <div class="border-t border-[#7471FB]"></div>
            ...
            <button @click="isOpen = !isOpen" class="w-full group flex items-center gap-2 md:gap-3 pr-5">
                ...
                <div :class="isOpenn ? 'py-1.5' : 'justify-center py-2'" class="flex justify-between items-center w-full py-1.5 px-3 bg-transparent transition-colors duration-300 group-hover:bg-white group-focus:bg-white rounded-md group-hover:shadow-lg group-hover:shadow-black/20 group-focus:shadow-lg group-focus:shadow-black/20">
                    <div class="flex items-center gap-2 md:gap-3">
                        <svg class="w-[14px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold transition-colors duration-300 group-hover:text-[#615EFC] group-focus:text-[#615EFC]">Laporan Evaluasi</h1>
                    </div>
                    <svg :class="{ 'block' : isOpenn, 'hidden' : !isOpenn, 'rotate-90' : isOpen }" class="w-[5px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 4 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="rpjmdes.php">
                    <button class="w-full group gap-2 md:gap-3 px-4 md:px-5">
                        <div class="flex items-center gap-2 md:gap-3 w-full py-1.5 px-3 bg-transparent">
                            ...
                            <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold">Evaluasi RPJMdes</h1>
                        </div>
                ...
                <a href="rkpdes.php">
                    <button class="w-full group gap-2 md:gap-3 px-4 md:px-5">
                        <div class="flex items-center gap-2 md:gap-3 w-full py-1.5 px-3 bg-transparent">
                            ...
                            <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold">Evaluasi RKPdes</h1>
                        </div>
                        <div class="mx-1.5 group-hover:border-b-[0.5px] group-hover:border-white group-focus:border-b-[0.5px] group-focus:border-white">
                    </button>
                </a>
                <a href="apedes.php">
                    <button class="w-full group gap-2 md:gap-3 px-4 md:px-5">
                        <div class="flex items-center gap-2 md:gap-3 w-full py-1.5 px-3 bg-transparent">
                            ...
                            <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold">Evaluasi APEdes</h1>
                        </div>
                        <div class="mx-1.5 group-hover:border-b-[0.5px] group-hover:border-white group-focus:border-b-[0.5px] group-focus:border-white">
                    </button>
                </a>
            ...
            <button @click="isOpen = !isOpen" class="w-full group flex items-center gap-2 md:gap-3 pr-5">
                ...
                <div :class="isOpenn ? 'py-1.5' : 'justify-center py-2'" class="flex justify-between items-center w-full py-1.5 px-3 bg-transparent transition-colors duration-300 group-hover:bg-white group-focus:bg-white rounded-md group-hover:shadow-lg group-hover:shadow-black/20 group-focus:shadow-lg group-focus:shadow-black/20">
                    <div class="flex items-center gap-2 md:gap-3">
                        ...
                        <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold transition-colors duration-300 group-hover:text-[#615EFC] group-focus:text-[#615EFC]">LPDD</h1>
                    </div>
                    <svg :class="{ 'block' : isOpenn, 'hidden' : !isOpenn, 'rotate-90' : isOpen }" class="w-[5px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 4 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.14131 0.772516C0.969697 0.602425 0.69269 0.603661 0.5226 0.775276C0.352509 0.946891 0.353745 1.2239 0.52536 1.39399L1.55376 2.41325C1.97113 2.82691 2.25743 3.11161 2.45116 3.35283C2.63934 3.58715 2.7039 3.73766 2.72108 3.87246C2.73187 3.9571 2.73187 4.04274 2.72108 4.12738C2.7039 4.26218 2.63934 4.41269 2.45116 4.64701C2.25743 4.88823 1.97113 5.17292 1.55376 5.58659L0.52536 6.60585C0.353745 6.77594 0.352509 7.05295 0.5226 7.22456C0.69269 7.39618 0.969697 7.39741 1.14131 7.22732L2.18824 6.1897C2.58255 5.7989 2.90483 5.47949 3.13339 5.1949C3.37105 4.89896 3.5431 4.59858 3.58906 4.23801C3.60921 4.07991 3.60921 3.91992 3.58906 3.76182C3.5431 3.40126 3.37105 3.10088 3.13339 2.80494C2.90483 2.52034 2.58256 2.20094 2.18824 1.81014L1.14131 0.772516Z"/>
                    </svg>
        ...
        <a href="lkppd.php" class="grid gap-3">
            <button class="w-full group flex items-center gap-2 md:gap-3 pr-5">
                <div class="invisible transition-all group-hover:visible group-focus:visible bg-white py-3.5 md:py-4 px-1 rounded-r-md"></div>
                <div :class="isOpenn ? 'py-1.5' : 'justify-center py-2'" class="flex justify-between items-center w-full py-1.5 px-3 bg-transparent transition-colors duration-300 group-hover:bg-white group-focus:bg-white rounded-md group-hover:shadow-lg group-hover:shadow-black/20 group-focus:shadow-lg group-focus:shadow-black/20">
                    <div class="flex items-center gap-2 md:gap-3">
                        <svg class="w-[14px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.63661 1.70736C0 2.58358 0 3.83349 0 6.33331V7.66665C0 10.1665 0 11.4164 0.63661 12.2926C0.842209 12.5756 1.09107 12.8244 1.37405 13.03C2.25027 13.6666 3.50018 13.6666 6 13.6666C8.49982 13.6666 9.74973 13.6666 10.626 13.03C10.9089 12.8244 11.1578 12.5756 11.3634 12.2926C12 11.4164 12 10.1665 12 7.66665V6.33331C12 3.83349 12 2.58358 11.3634 1.70736C11.1578 1.42438 10.9089 1.17552 10.626 0.969923C9.74973 0.333313 8.49982 0.333313 6 0.333313C3.50018 0.333313 2.25027 0.333313 1.37405 0.969923C1.09107 1.17552 0.842209 1.42438 0.63661 1.70736ZM3.33333 3.83331C3.05719 3.83331 2.83333 4.05717 2.83333 4.33331C2.83333 4.60946 3.05719 4.83331 3.33333 4.83331H8.66667C8.94281 4.83331 9.16667 4.60946 9.16667 4.33331C9.16667 4.05717 8.94281 3.83331 8.66667 3.83331H3.33333ZM3.33333 6.49998C3.05719 6.49998 2.83333 6.72384 2.83333 6.99998C2.83333 7.27612 3.05719 7.49998 3.33333 7.49998H5.33333C5.60948 7.49998 5.83333 7.27612 5.83333 6.99998C5.83333 6.72384 5.60948 6.49998 5.33333 6.49998H3.33333ZM3.33333 9.16665C3.05719 9.16665 2.83333 9.3905 2.83333 9.66665C2.83333 9.94279 3.05719 10.1666 3.33333 10.1666H8.66667C8.94281 10.1666 9.16667 9.94279 9.16667 9.66665C9.16667 9.3905 8.94281 9.16665 8.66667 9.16665H3.33333Z"/>
                        </svg>
                        <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold transition-colors duration-300 group-hover:text-[#615EFC] group-focus:text-[#615EFC]">LKPPD</h1>
                    </div>
                    <svg :class="{ 'block' : isOpenn, 'hidden' : !isOpenn }" class="w-[5px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 4 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.14131 0.772516C0.969697 0.602425 0.69269 0.603661 0.5226 0.775276C0.352509 0.946891 0.353745 1.2239 0.52536 1.39399L1.55376 2.41325C1.97113 2.82691 2.25743 3.11161 2.45116 3.35283C2.63934 3.58715 2.7039 3.73766 2.72108 3.87246C2.73187 3.9571 2.73187 4.04274 2.72108 4.12738C2.7039 4.26218 2.63934 4.41269 2.45116 4.64701C2.25743 4.88823 1.97113 5.17292 1.55376 5.58659L0.52536 6.60585C0.353745 6.77594 0.352509 7.05295 0.5226 7.22456C0.69269 7.39618 0.969697 7.39741 1.14131 7.22732L2.18824 6.1897C2.58255 5.7989 2.90483 5.47949 3.13339 5.1949C3.37105 4.89896 3.5431 4.59858 3.58906 4.23801C3.60921 4.07991 3.60921 3.91992 3.58906 3.76182C3.5431 3.40126 3.37105 3.10088 3.13339 2.80494C2.90483 2.52034 2.58256 2.20094 2.18824 1.81014L1.14131 0.772516Z"/>
                    </svg>
                </div>
            </button>
        </a>
        <a href="bpd.php" class="grid gap-3">
            <button class="w-full group flex items-center gap-2 md:gap-3 pr-5">
                <div class="invisible transition-all group-hover:visible group-focus:visible bg-white py-3.5 md:py-4 px-1 rounded-r-md"></div>
                <div :class="isOpenn ? 'py-1.5' : 'justify-center py-2'" class="flex justify-between items-center w-full py-1.5 px-3 bg-transparent transition-colors duration-300 group-hover:bg-white group-focus:bg-white rounded-md group-hover:shadow-lg group-hover:shadow-black/20 group-focus:shadow-lg group-focus:shadow-black/20">
                    <div class="flex items-center gap-2 md:gap-3">
                        <svg class="w-[14px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold transition-colors duration-300 group-hover:text-[#615EFC] group-focus:text-[#615EFC]">BPD</h1>
                    </div>
                    <svg :class="{ 'block' : isOpenn, 'hidden' : !isOpenn }" class="w-[5px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 4 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.14131 0.772516C0.969697 0.602425 0.69269 0.603661 0.5226 0.775276C0.352509 0.946891 0.353745 1.2239 0.52536 1.39399L1.55376 2.41325C1.97113 2.82691 2.25743 3.11161 2.45116 3.35283C2.63934 3.58715 2.7039 3.73766 2.72108 3.87246C2.73187 3.9571 2.73187 4.04274 2.72108 4.12738C2.7039 4.26218 2.63934 4.41269 2.45116 4.64701C2.25743 4.88823 1.97113 5.17292 1.55376 5.58659L0.52536 6.60585C0.353745 6.77594 0.352509 7.05295 0.5226 7.22456C0.69269 7.39618 0.969697 7.39741 1.14131 7.22732L2.18824 6.1897C2.58255 5.7989 2.90483 5.47949 3.13339 5.1949C3.37105 4.89896 3.5431 4.59858 3.58906 4.23801C3.60921 4.07991 3.60921 3.91992 3.58906 3.76182C3.5431 3.40126 3.37105 3.10088 3.13339 2.80494C2.90483 2.52034 2.58256 2.20094 2.18824 1.81014L1.14131 0.772516Z"/>
                    </svg>
        ...
        <div x-data="{ isOpen : false }" @click.outside="isOpen = false" class="grid gap-3">
            <button @click="isOpen = !isOpen" class="w-full group flex items-center gap-2 md:gap-3 pr-5">
                ...
                <div :class="isOpenn ? 'py-1.5' : 'justify-center py-2'" class="flex justify-between items-center w-full py-1.5 px-3 bg-transparent transition-colors duration-300 group-hover:bg-white group-focus:bg-white rounded-md group-hover:shadow-lg group-hover:shadow-black/20 group-focus:shadow-lg group-focus:shadow-black/20">
                    <div class="flex items-center gap-2 md:gap-3">
                        <svg class="w-[14px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold transition-colors duration-300 group-hover:text-[#615EFC] group-focus:text-[#615EFC]">APBDES</h1>
                    </div>
                    <svg :class="{ 'block' : isOpenn, 'hidden' : !isOpenn, 'rotate-90' : isOpen }" class="w-[5px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 4 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.14131 0.772516C0.969697 0.602425 0.69269 0.603661 0.5226 0.775276C0.352509 0.946891 0.353745 1.2239 0.52536 1.39399L1.55376 2.41325C1.97113 2.82691 2.25743 3.11161 2.45116 3.35283C2.63934 3.58715 2.7039 3.73766 2.72108 3.87246C2.73187 3.9571 2.73187 4.04274 2.72108 4.12738C2.7039 4.26218 2.63934 4.41269 2.45116 4.64701C2.25743 4.88823 1.97113 5.17292 1.55376 5.58659L0.52536 6.60585C0.353745 6.77594 0.352509 7.05295 0.5226 7.22456C0.69269 7.39618 0.969697 7.39741 1.14131 7.22732L2.18824 6.1897C2.58255 5.7989 2.90483 5.47949 3.13339 5.1949C3.37105 4.89896 3.5431 4.59858 3.58906 4.23801C3.60921 4.07991 3.60921 3.91992 3.58906 3.76182C3.5431 3.40126 3.37105 3.10088 3.13339 2.80494C2.90483 2.52034 2.58256 2.20094 2.18824 1.81014L1.14131 0.772516Z"/>
                    </svg>
        ...
        <a href="kependudukan.php" class="grid gap-3">
            <button class="w-full group flex items-center gap-2 md:gap-3 pr-5">
                <div class="invisible transition-all group-hover:visible group-focus:visible bg-white py-3.5 md:py-4 px-1 rounded-r-md"></div>
                <div :class="isOpenn ? 'py-1.5' : 'justify-center py-2'" class="flex justify-between items-center w-full py-1.5 px-3 bg-transparent transition-colors duration-300 group-hover:bg-white group-focus:bg-white rounded-md group-hover:shadow-lg group-hover:shadow-black/20 group-focus:shadow-lg group-focus:shadow-black/20">
                    <div class="flex items-center gap-2 md:gap-3">
                        ...
                        <h1 :class="isOpenn ? 'block' : 'hidden'" class="text-xs md:text-sm text-white font-semibold transition-colors duration-300 group-hover:text-[#615EFC] group-focus:text-[#615EFC]">Kependudukan</h1>
                    </div>
                    <svg :class="{ 'block' : isOpenn, 'hidden' : !isOpenn }" class="w-[5px] fill-white transition-colors duration-300 group-hover:fill-[#615EFC] group-focus:fill-[#615EFC]" viewBox="0 0 4 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.14131 0.772516C0.969697 0.602425 0.69269 0.603661 0.5226 0.775276C0.352509 0.946891 0.353745 1.2239 0.52536 1.39399L1.55376 2.41325C1.97113 2.82691 2.25743 3.11161 2.45116 3.35283C2.63934 3.58715 2.7039 3.73766 2.72108 3.87246C2.73187 3.9571 2.73187 4.04274 2.72108 4.12738C2.7039 4.26218 2.63934 4.41269 2.45116 4.64701C2.25743 4.88823 1.97113 5.17292 1.55376 5.58659L0.52536 6.60585C0.353745 6.77594 0.352509 7.05295 0.5226 7.22456C0.69269 7.39618 0.969697 7.39741 1.14131 7.22732L2.18824 6.1897C2.58255 5.7989 2.90483 5.47949 3.13339 5.1949C3.37105 4.89896 3.5431 4.59858 3.58906 4.23801C3.60921 4.07991 3.60921 3.91992 3.58906 3.76182C3.5431 3.40126 3.37105 3.10088 3.13339 2.80494C2.90483 2.52034 2.58256 2.20094 2.18824 1.81014L1.14131 0.772516Z"/>
                    </svg>

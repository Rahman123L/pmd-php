<section x-show="step === 5" class="hidden" :class="{ 'block': step === 5, 'hidden': !step === 5 }">
    <div class="overflow-scroll w-[95%] h-52 bg-transparent p-2 mx-5">
        <table class="bg-white table-auto">
            <tr class="text-[10px] md:text-xs text-black capitalize">
                ...
                <th class="w-[45%] bg-white border border-black text-start font-bold py-1.5 px-4">Nama Rincian</th>
            ...
            <tr class="odd:bg-white even:bg-[#EAE9E9] text-xs text-black capitalize overflow-visible">
                ...
                <td class="border border-black text-start font-normal py-1.5 px-4">
                    <h1 class="line-clamp-1">Gaji Kepala Desa</h1>
                </td>
                <td class="border border-black text-start font-normal py-1.5 px-4">
    ...
    <div class="grid gap-3 py-2 px-5">
        <div class="grid md:flex justify-between items-center gap-2">
            ...
            <label class="grid md:flex justify-end items-center gap-1 md:gap-6">
                <input type="text" value="Rp. 0" class="w-fit bg-white py-1.5 px-3 border border-[#DCDBDB] rounded-lg shadow-md text-[10px] md:text-xs text-black font-normal capitalize placeholder:text-black focus:ring-0 focus:border-[#DCDBDB]">
            </label>
        </div>
        <label class="w-full grid md:flex items-center gap-1 md:gap-9">
            ...
            <div class="w-full grid md:flex items-center gap-1 md:gap-3">
                <input type="text" value="Gaji Kepala Desa" class="w-full md:w-[70%] bg-white py-1.5 px-3 border border-[#DCDBDB] rounded-lg shadow-md text-[10px] md:text-xs text-black font-normal capitalize placeholder:text-black focus:ring-0 focus:border-[#DCDBDB]">
        ...
        <div class="w-full md:w-[80%] grid grid-cols-1 md:grid-cols-2 gap-1">
            <div class="space-y-2">
                <label class="grid md:flex items-center gap-1 md:gap-5">
                    ...
                    <input type="text" value="Rp. 42.000.000" class="w-full md:w-[70%] bg-white py-1.5 px-3 border border-[#DCDBDB] rounded-lg shadow-md text-[10px] md:text-xs text-black font-normal capitalize placeholder:text-black focus:ring-0 focus:border-[#DCDBDB]">
                </label>
            ...
            <div class="space-y-2">
                <label class="grid md:flex items-center gap-1 md:gap-5">
                    ...
                    <div class="grid md:flex items-center gap-2">
                        <input type="text" value="12" class="w-full md:w-[30%] bg-white py-1.5 px-3 border border-[#DCDBDB] rounded-lg shadow-md text-[10px] md:text-xs text-black font-normal capitalize placeholder:text-black focus:ring-0 focus:border-[#DCDBDB]">
                        <input type="text" value="Bulan" class="w-full md:w-[30%] bg-white py-1.5 px-3 border border-[#DCDBDB] rounded-lg shadow-md text-[10px] md:text-xs text-black font-normal capitalize placeholder:text-black focus:ring-0 focus:border-[#DCDBDB]">
                    </div>
                </label>

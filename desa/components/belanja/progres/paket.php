<section x-show="step === 3" class="hidden" :class="{ 'block': step === 3, 'hidden': !step === 3 }">
    <div class="overflow-scroll w-[95%] h-52 bg-transparent p-2 mx-5">
        <table class="bg-white table-auto">
            <tr class="text-[10px] md:text-xs text-black capitalize">
                ...
                <th class="w-[20%] bg-white border border-black text-start font-bold py-1.5 px-4">No. Urut</th>
                <th class="w-[35%] bg-white border border-black text-start font-bold py-1.5 px-4">Nama Sub Kegiatan</th>
    ...
    <div class="grid gap-3 py-2 px-5">
        <label class="grid md:flex justify-end items-center gap-1 md:gap-6">
            <input type="text" value="Rp. 58.700.000" class="w-[60%] md:w-fit bg-white py-1.5 px-3 border border-[#DCDBDB] rounded-lg shadow-md text-[10px] md:text-xs text-black font-normal capitalize placeholder:text-black focus:ring-0 focus:border-[#DCDBDB]">
        </label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="space-y-2">
                <label class="grid md:flex items-center gap-1 md:gap-5">
                    ...
                    <input type="text" value="Rp. 42.000.000" class="w-full md:w-fit bg-white py-1.5 px-3 border border-[#DCDBDB] rounded-lg shadow-md text-[10px] md:text-xs text-black font-normal capitalize placeholder:text-black focus:ring-0 focus:border-[#DCDBDB]">
                </label>

...
<div x-data="{ isOpenn : true }">
    ...
    <main :class="isOpenn ? 'md:ml-60' : 'md:ml-20 ' + 'transition-all duration-500'" class="relative md:ml-60 pt-16 p-5 space-y-5">
        <div class="md:flex justify-between items-center">
            <h1 class="text-base md:text-lg lg:text-xl text-black font-medium">Belanja</h1>
            <h1 class="text-xs md:text-sm text-black font-medium"><span class="text-primary font-medium">Home</span> / Penyusunan APBDES / Belanja</h1>
        </div>

        <div class="bg-white rounded-lg">
            <div x-data="{ step: 5 }" class="space-y-3">
                <div class="flex justify-between items-center p-6 md:px-10 lg:px-16">
                    ...
                    <div class="relative flex justify-center items-center">
                        ...
                        <h1 class="absolute -bottom-6 w-max text-[10px] md:text-xs text-black font-semibold">Paket</h1>
                    </div>
                    ...
                    <div class="relative flex justify-center items-center">
                        ...
                        <h1 class="absolute -bottom-6 w-max text-[10px] md:text-xs text-black font-semibold">RAB</h1>
                    </div>
                    <hr class="border-2 w-full" :class="step >= 5 ? 'border-primary' : 'bg-gray-300'">
                    <div class="relative flex justify-center items-center">
                        <button @click="step = 5" class="text-[10px] md:text-xs px-2.5 py-1.5 font-bold rounded-full text-white" :class="step >= 5 ? 'bg-primary' : 'bg-gray-300'">5</button>
                        <h1 class="absolute -bottom-8 md:-bottom-6 w-full md:w-max text-[10px] md:text-xs text-black font-semibold">RAB Revisi</h1>
                    </div>
                </div>
                <hr class="border border-gray-300"></hr>
            
                <?php include_once("../desa/components/belanja/progres/bidang.php"); ?>
                <?php include_once("../desa/components/belanja/progres/kegiatan.php"); ?>
                <?php include_once("../desa/components/belanja/progres/paket.php"); ?>
                <?php include_once("../desa/components/belanja/progres/rab.php"); ?>
                <?php include_once("../desa/components/belanja/progres/rabRevisi.php"); ?>

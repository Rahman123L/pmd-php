...
<div x-data="{ isOpenn : true }">
    ...
    <main :class="isOpenn ? 'md:ml-60' : 'md:ml-20 ' + 'transition-all duration-500'" class="relative md:ml-60 pt-16 p-5 space-y-5">
        ...
        <div class="grid w-full divide-y-[1.5px] bg-white rounded md:rounded-md shadow-md shadow-black/20">
                        ...
                        <div x-show="modal" x-transition.duration.300ms.opacity.50 :class="{ 'visible': modal, 'invisible': !modal }" class="invisible fixed inset-0 z-50 bg-[#0000006E] flex items-center justify-center h-screen">
                            <div class="w-[80%] sm:w-[50%] md:w-[40%] lg:w-[25%] bg-white rounded-lg md:rounded-xl">
                                ...
                                <div class="pt-2.5 pb-3.5 px-5 space-y-8">
                                    <h1 class="text-center text-sm md:text-base text-black font-normal">Apakah anda yakin ingin menghapus pesan ?</h1>
            ...
            <a href="" class="grid grid-cols-1 lg:grid-cols-6 gap-1.5 place-items-start bg-white py-4 px-6 hover:border-[1px] hover:border-[#0000006E] hover:shadow-md hover:shadow-black/20">
                <div class="col-span-1 lg:col-span-2 flex items-center gap-2 md:gap-3">
                    <input type="checkbox" name="" id="" class="appearance-none checked:bg-gray-500 rounded bg-transparent border-gray-500 checked:border-gray-500 ring-gray-500 checked:ring-gray-500">
                    <h1 class="text-xs md:text-sm text-black font-medium">Kepada : <span class="font-medium">admin pmd</span></h1>
                </div>
                <div class="col-span-1 lg:col-span-3 space-y-1.5">
                    ...
                    <div class="flex items-center gap-2">
                        <svg class="w-3 fill-[#BDBCBC]" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 class="text-[8px] md:text-[10px] text-[#BDBCBC] font-normal">Belum dilihat admin</h1>
                    </div>
                </div>
                <h1 class="col-span-1 lg:col-span-1 text-[10px] md:text-xs text-black font-normal">Baru saja</h1>
            </a>
            <a href="" class="grid grid-cols-1 lg:grid-cols-6 gap-1.5 place-items-start bg-white py-4 px-6 hover:border-[1px] hover:border-[#0000006E] hover:shadow-md hover:shadow-black/20">
                <div class="col-span-1 lg:col-span-2 flex items-center gap-2 md:gap-3">
                    <input type="checkbox" name="" id="" class="appearance-none checked:bg-gray-500 rounded bg-transparent border-gray-500 checked:border-gray-500 ring-gray-500 checked:ring-gray-500">
                ...
                <h1 class="col-span-1 lg:col-span-1 text-[10px] md:text-xs text-black font-normal">14 menit yang lalu</h1>
            </a>
            <a href="" class="grid grid-cols-1 lg:grid-cols-6 gap-1.5 place-items-start bg-white py-4 px-6 hover:border-[1px] hover:border-[#0000006E] hover:shadow-md hover:shadow-black/20">
                <div class="col-span-1 lg:col-span-2 flex items-center gap-2 md:gap-3">
                    <input type="checkbox" name="" id="" class="appearance-none checked:bg-gray-500 rounded bg-transparent border-gray-500 checked:border-gray-500 ring-gray-500 checked:ring-gray-500">

<section x-show="step === 2" class="hidden" :class="{ 'block': step === 2, 'hidden': !step === 2 }">
    <div class="overflow-scroll w-[80%] h-52 bg-transparent p-2 mx-5">
        <table class="bg-white table-auto">
            <tr class="text-[10px] md:text-xs text-black capitalize">
                ...
                <th class="w-[70%] bg-white border border-black text-start font-bold py-1.5 px-4">Nama Sub Bidang</th>
            </tr>
    ...
    <div class="py-2 px-5 grid gap-2">
        <label class="grid md:flex items-center gap-1 md:gap-[66px]">
            <h1 class="text-[10px] md:text-xs text-black font-normal capitalize">Kode Sub</h1>
            <input type="text" placeholder="01.2024.01" class="w-full md:w-fit bg-white py-1.5 px-3 border border-[#DCDBDB] rounded-lg shadow-md text-[10px] md:text-xs text-black font-normal capitalize placeholder:text-black focus:ring-0 focus:border-[#DCDBDB]">
        </label>
        <label class="grid md:flex items-center gap-1 md:gap-5">
            <h1 class="text-[10px] md:text-xs text-black font-normal capitalize">Nama Sub Bidang</h1>

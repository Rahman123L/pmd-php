    ...
    <main :class="isOpenn ? 'md:ml-60' : 'md:ml-20 ' + 'transition-all duration-500'" class="relative md:ml-60 pt-16 p-5 space-y-5">
        ...
        <div class="bg-white rounded-lg">
            <div x-data="{ step: 1 }" class="space-y-3">
                ...
                <?php include_once("../desa/components/kegiatan/progres/bidang.php"); ?>
                <?php include_once("../desa/components/kegiatan/progres/subBidang.php"); ?>
                <?php include_once("../desa/components/kegiatan/progres/kegiatan.php"); ?>
                <?php include_once("../desa/components/kegiatan/progres/paketKegiatan.php"); ?>

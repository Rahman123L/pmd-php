...
<div x-data="{ isOpenn : true }">
    ...
    <main :class="isOpenn ? 'md:ml-60' : 'md:ml-20 ' + 'transition-all duration-500'" class="relative md:ml-60 pt-16 p-5 space-y-5">
        <div class="md:flex justify-between items-center">
            ...
            <h1 class="text-xs md:text-sm text-black font-medium"><span class="text-primary font-medium">Home</span> / Penyusunan APBDES / Pendapatan</h1>
        </div>
        ...
        <div class="bg-white rounded-lg">
            <div x-data="{ step: 1 }" class="space-y-3">
                ...
                <?php include_once("../desa/components/pendapatan/progres/rap.php"); ?>
                <?php include_once("../desa/components/pendapatan/progres/rapRincian.php"); ?>

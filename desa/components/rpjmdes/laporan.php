...
<div x-data="{ isOpenn : true }">
    ...
    <main :class="isOpenn ? 'md:ml-60' : 'md:ml-20 ' + 'transition-all duration-500'" class="relative md:ml-60 pt-16 p-5 space-y-4 md:space-y-5">
        <div class="md:flex md:justify-between items-center">
            ...
            <h1 class="text-xs md:text-sm text-black font-medium"><span class="text-primary font-medium">Home</span> / Detail Laporan</h1>
        </div>
        
        <?php include_once("../desa/components/laporan/content.php") ?>
    </main>
</div>
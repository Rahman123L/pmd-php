...
<div x-data="{ isOpenn : true }">
    ...
    <main :class="isOpenn ? 'md:ml-60' : 'md:ml-20 ' + 'transition-all duration-500'" class="relative md:ml-60 pt-16 p-5 space-y-5">
        <div class="flex justify-between items-center">
            <h1 class="text-base md:text-lg lg:text-xl text-black font-medium">Outbox</h1>
            <h1 class="text-xs md:text-sm text-black font-medium"><span class="text-primary font-medium">Home</span> / Outbox</h1>
        </div>
        ...
        <div class="grid w-full divide-y-[1.5px] bg-white rounded md:rounded-md shadow-md shadow-black/20">
            ...
            <a href="" class="grid grid-cols-1 lg:grid-cols-6 gap-1.5 place-items-start bg-[#F4F3FF] py-4 px-6 hover:border-[1px] hover:border-[#0000006E] hover:shadow-md hover:shadow-black/20">
                <div class="col-span-1 lg:col-span-2 flex items-center gap-2 md:gap-3">
                    ...
                    <h1 class="text-xs md:text-sm text-black font-medium">Anonymouse</h1>
                </div>
                <div class="col-span-1 lg:col-span-3 space-y-1.5">
                    <p class="text-[10px] md:text-xs text-black font-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse consequatur magni voluptates necessitatibus quos quae.</p>
                </div>

<section x-show="step === 2" class="hidden overflow-scroll w-[95%] h-72 bg-transparent p-2 mx-5" :class="{ 'block': step === 2, 'hidden': !step === 2 }">
    <table class="bg-white table-auto">
        <tr class="text-[10px] md:text-xs text-black capitalize">
            ...
            <th class="w-[20%] bg-white border border-black text-start font-bold py-1.5 px-4">Uraian</th>
            <th class="w-[40%] bg-white border border-black text-start font-bold py-1.5 px-4">Anggaran</th>
            <th class="w-[30%] bg-white border border-black text-start font-bold py-1.5 px-4">Anggaran PAK</th>

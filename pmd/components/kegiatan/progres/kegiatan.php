<section x-show="step === 3" class="hidden overflow-scroll w-[80%] h-72 bg-transparent p-2 mx-5" :class="{ 'block': step === 3, 'hidden': !step === 3 }">
    <table class="bg-white table-auto">
        <tr class="text-[10px] md:text-xs text-black capitalize">
            ...
            <th class="w-[65%] bg-white border border-black text-start font-bold py-1.5 px-4">Nama Kegiatan</th>
